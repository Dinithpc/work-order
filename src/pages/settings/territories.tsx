...
import { Layout as SettingsLayout } from '../../layouts/settings';
import { Box, Card,   SvgIcon, Button, Typography , Modal , Tabs , Stack , TextField , CardContent,    Unstable_Grid2 as Grid,   Tab, Divider} from '@mui/material';
import ArrowLeftIcon from '@heroicons/react/24/outline/ArrowLeftIcon';
import { useCallback, useEffect, useMemo, useState } from 'react';

import { CustomersTable } from '../../sections/settings/territories-table';
